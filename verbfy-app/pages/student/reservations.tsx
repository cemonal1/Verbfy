        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1">View and manage your booked lessons</p>
            </div>
          ...
          {filteredReservations.length > 0 ? (
            <div className="divide-y divide-gray-200">
              {filteredReservations.map((reservation) => {
                ...
                // For future lessons, allow joining 15 minutes before start time
                ...
                // Can cancel if lesson is in the future and hasn't started yet
                const canCancel = reservation.status === 'booked' && timeDiffMinutes > 15;
                      ...
                      <div className="flex-1">
                        <div className="flex items-center space-x-4">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-gray-600">{reservation.teacher.email}</p>
