...
export default function VerbfyWritePage() {
  ...
  const category = useMemo(() => 'Writing', []);
  ...
  return (
    <div className="min-h-screen bg-white">
      <Head>
        <title>VerbfyWrite</title>
      </Head>
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="mb-8">
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-900">VerbfyWrite</h1>
          <p className="text-gray-600 mt-2">
            {locale === 'tr'
              ? 'Yazma görevleri, şablonlar ve geri bildirimle yazma becerinizi geliştirin.'
              : 'Improve your writing with tasks, templates and targeted feedback.'}
          </p>
        </div>
              ...
              return (
                <div key={id} className="group bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-all">
                  <div className="relative h-40">
                    <Image src={m.thumbnailUrl || '/images/verbfy-write.png'} alt={m.title} fill className="object-contain p-4 group-hover:scale-105 transition-transform duration-200" />
                  </div>
                  <div className="p-4">
                    ...
                    <div className="mt-3 flex items-center justify-between text-sm text-gray-500">
                      ...
                      <button
                        ...
                        className={`px-3 py-1 rounded-md border ${
                          isSel ? 'bg-purple-600 text-white border-purple-600' : 'border-gray-300 hover:bg-gray-50'
                        }`}
                      >
